...
\begin{figure}[htbp]
  ...
  \caption{Offensive (left) and defensive (right) \xvoa{}/game vs.\ win percentage. The tighter clustering and steeper regression line for offense demonstrate that offensive quality explains substantially more win-rate variance ($R^2 = 46.4\%$) than defensive quality ($R^2 = 14.1\%$).}
